...
just a second-year engineering student trying to figure things out.
...
🤖 ai & generative ai (still learning, always curious)

💻 coding and building random things

🌐 web stuff & APIs

🧩 problem solving (when my brain cooperates)
...
🍳 i really like cooking (experimenting > recipes)
...
📖 how i learn (most of the time)

try → fail → google → try again
